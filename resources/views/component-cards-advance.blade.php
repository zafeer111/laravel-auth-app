...
@endsection
@section('content')
    <x-page-title title="Components" subtitle="Advance Cards" />
                ...
                <div class="card-body p-4">
                    ...
                    <div class="mt-5">
                        ...
                        <div class="row row-cols-1 row-cols-lg-2 g-4">
                            <div class="col">
                                <div class="text-center">
                                    <img src="https://placehold.co/200x150/png" class="img-fluid rounded" alt="">
                        ...
                        <div class="col">
                            <div class="card shadow-none bg-voilet mb-0" style="height: 160px;">
                                <div class="card-body">
                                    ...
                                    <img src="{{ URL::asset('build/images/cat/01.png') }}" class="position-absolute end-0 bottom-0"
                                        width="140" alt="">
                                </div>
                            </div>
                        </div>
                        <div class="col">
                            <div class="card shadow-none bg-success mb-0" style="height: 160px;">
                                <div class="card-body">
                                    ...
                                    <img src="{{ URL::asset('build/images/cat/02.png') }}" class="position-absolute end-0 bottom-0"
                                        width="90" alt="">
                                </div>
                            </div>
                        </div>
                        <div class="col">
                            <div class="card shadow-none bg-dark-blue mb-0" style="height: 160px;">
                                <div class="card-body">
                                    ...
                                    <img src="{{ URL::asset('build/images/cat/03.png') }}" class="position-absolute end-0 bottom-0"
                                        width="120" alt="">
                                </div>
                            </div>
                        </div>
                        <div class="col">
                            <div class="card shadow-none bg-danger mb-0" style="height: 160px;">
                                <div class="card-body">
                                    ...
                                    <img src="{{ URL::asset('build/images/cat/04.png') }}" class="position-absolute end-0 bottom-0 m-2"
                                        width="160" alt="">
                                </div>
                            </div>
                        </div>
                        <div class="col">
                            <div class="card shadow-none bg-orange mb-0" style="height: 160px;">
                                <div class="card-body">
                                    ...
                                    <img src="{{ URL::asset('build/images/cat/05.png') }}" class="position-absolute end-0 bottom-0"
                                        width="130" alt="">
                                </div>
                            </div>
                        </div>
                        <div class="col">
                            <div class="card shadow-none bg-indigo mb-0" style="height: 160px;">
                                <div class="card-body">
                                    ...
                                    <img src="{{ URL::asset('build/images/cat/06.png') }}" class="position-absolute end-0 bottom-0 m-2"
                                        width="200" alt="">
                                </div>
                            </div>
                        </div>
