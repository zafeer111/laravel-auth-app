            ...
            <div class="row pt-5">
                <div class="col-lg-12">
                    <div class="text-center error-pages">
                        ...
                        <p class="text-light">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod
                        ...
                        <div class="mt-4 d-flex align-items-center justify-content-center gap-3">
                            <a href="{{ url('/index') }}" class="btn btn-success rounded-5 px-4"><i
                                    class="bi bi-house-fill me-2"></i>Go To Home</a>
                            <a href="javascript:void();" class="btn btn-outline-light rounded-5 px-4"><i
