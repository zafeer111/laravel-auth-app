...
<x-page-title title="Apps" subtitle="Email" />

    <!--start email wrapper-->
    <div class="email-wrapper">
        <div class="email-sidebar">
            <div class="email-sidebar-header d-grid"><a href="javascript:;"
                    class="btn btn-grd btn-grd-primary compose-mail-btn"><i class='bx bx-plus me-2'></i> Compose</a>
            </div>
            <div class="email-sidebar-content">
                <div class="email-navigation">
                    <div class="list-group list-group-flush">
                        <a href="{{ url('/app-emailbox') }}" class="list-group-item active d-flex align-items-center"><i
                ...
                <div class="email-meeting">
                    <div class="list-group list-group-flush">
                        ...
                        </div> <a href="javascript:;" class="list-group-item d-flex align-items-center"><i
                        ...
                        <div class="list-group-item email-hangout cursor-pointer border-top">
                            <div class="d-flex align-items-center gap-3">
                                <div class="chat-user-online">
                                    <img src="https://placehold.co/110x110/png" width="42" height="42"
                ...
                <div class="email-list">
                        ...
                        <div class="d-md-flex align-items-center email-message px-3 py-1">
                            <div class="d-flex align-items-center email-actions">
                                <input class="form-check-input" type="checkbox" value=""><i
                                    class='bx bx-star font-20 mx-2 email-star'></i>
                    ...
                    <a href="{{ url('/app-emailread') }}">
                        <div class="d-md-flex align-items-center email-message px-3 py-1">
                            ...
                            <div class="">
                                <p class="mb-0">The point of using Lorem Ipsum is that it has a more-or-less normal...
                                </p>
                            </div>
                            <div class="ms-auto">
                    ...
                    <a href="{{ url('/app-emailread') }}">
                        <div class="d-md-flex align-items-center email-message px-3 py-1 mail-read">
                            ...
                            <div class="">
                                <p class="mb-0">There are many variations of passages of Lorem Ipsum available, majority
                                    suffered...</p>
                            </div>
                            <div class="ms-auto">
                    ...
                    <a href="{{ url('/app-emailread') }}">
                        <div class="d-md-flex align-items-center email-message px-3 py-1">
                            ...
                            <div class="">
                                <p class="mb-0">Richard McClintock, a Latin professor at Hampden-Sydney College in
                                    Virginia...</p>
                            </div>
                            <div class="ms-auto">
                    ...
                    <a href="{{ url('/app-emailread') }}">
                        <div class="d-md-flex align-items-center email-message px-3 py-1">
                            ...
                            <div class="">
                                <p class="mb-0">If you are going to use a passage of Lorem Ipsum, you need to be sure
                                    there...</p>
                            </div>
                            <div class="ms-auto">
                    ...
                    <a href="{{ url('/app-emailread') }}">
                        <div class="d-md-flex align-items-center email-message px-3 py-1 mail-read">
                            ...
                            <div class="">
                                <p class="mb-0">Bonorum et Malorum" by Cicero are also reproduced in their exact original
                                    form...</p>
                            </div>
                            <div class="ms-auto">
                    ...
                    <a href="{{ url('/app-emailread') }}">
                        <div class="d-md-flex align-items-center email-message px-3 py-1 mail-read">
                            ...
                            <div class="">
                                <p class="mb-0">But I must explain to you how all this mistaken idea of denouncing
                                    pleasure...</p>
                            </div>
                            <div class="ms-auto">
                    ...
                    <a href="{{ url('/app-emailread') }}">
                        <div class="d-md-flex align-items-center email-message px-3 py-1 mail-read">
                            ...
                            <div class="">
                                <p class="mb-0">On the other hand, we denounce with righteous indignation and dislike...
                                </p>
                            </div>
                            <div class="ms-auto">
                    ...
                    <a href="{{ url('/app-emailread') }}">
                        <div class="d-md-flex align-items-center email-message px-3 py-1">
                            ...
                            <div class="">
                                <p class="mb-0">Ut enim ad minima veniam, quis nostrum exercitationem ullam corporis
                                    suscipit...</p>
                            </div>
                            <div class="ms-auto">
                    ...
                    <a href="{{ url('/app-emailread') }}">
                        <div class="d-md-flex align-items-center email-message px-3 py-1">
                            ...
                            <div class="">
                                <p class="mb-0">Various versions have evolved over the years, sometimes by accident...
                                </p>
                            </div>
                            <div class="ms-auto">
                    ...
                    <a href="{{ url('/app-emailread') }}">
                        <div class="d-md-flex align-items-center email-message px-3 py-1 mail-read">
                            ...
                            <div class="">
                                <p class="mb-0">Business it will frequently occur that pleasures have to be repudiated...
                                </p>
                            </div>
                            <div class="ms-auto">
                    ...
                    <a href="{{ url('/app-emailread') }}">
                        <div class="d-md-flex align-items-center email-message px-3 py-1">
                            ...
                            <div class="">
                                <p class="mb-0">Chunks as necessary, making this the first true generator on the
                                    Internet...</p>
                            </div>
                            <div class="ms-auto">
                            ...
                            <div class="d-flex align-items-center">
                                <div class="">
                                    <div class="btn-group">
                                        ...
                                        <button type="button"
                                            class="btn btn-grd btn-grd-primary split-bg-primary dropdown-toggle dropdown-toggle-split"
